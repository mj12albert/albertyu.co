  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Albert Yu is a developer &amp; designer. Currently based in Hong Kong."
        />
      ...
      <main sx={{ bg: 'gray.2' }}>
        <section sx={{ minHeight: '100vh', p: 5 }}>
          ...
          <Text sx={{ fontSize: 18 }}>
            Currently at{' '}
            <ExternalLink href="google.com" sx={{ fontSize: 'inherit' }}>
              Neat
            </ExternalLink>{' '}
            – we’re working on bringing modern financial services for businesses
            on the web.
          </Text>
        </section>
